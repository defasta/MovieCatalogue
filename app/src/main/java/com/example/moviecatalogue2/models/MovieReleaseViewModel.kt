...
class MovieReleaseViewModel : ViewModel(){
    ...
    fun setMovie(date: String?){
        val listItems = ArrayList<Movie>()
        val url = "https://api.themoviedb.org/3/discover/movie?api_key=$API_KEY&primary_release_date.gte=$date&primary_release_date.lte={TODAY DATE}"
